...
bool employe::ajouter()
{
    ...
    if(!query.exec()){
        qDebug() << "Erreur ajouter employe:" << query.lastError().text();
        return false;
    }
    return true;
}
...
QSqlQueryModel * employe::afficher()
{
    ...
    model->setQuery("SELECT ID_EMPLOYE, NOM, PRENOM, POSTE, DEPARTEMENT, SALAIRE, DATE_EMBAUCHE FROM EMPLOYES ORDER BY ID_EMPLOYE DESC");
