...
void MainWindow::showStockRavitaillementTab() {
    ...
    bool simpleModeEnabled = settings.value("ravitaillement/simple_mode", true).toBool();
    ...
    QLabel *titre = new QLabel("Ravitaillement Matières Premières");
    ...
    QPushButton *btnComparer = new QPushButton("1) Analyser fournisseurs");
    ...
    guideL->setSpacing(8);
    QLabel *lblGuide = new QLabel("Etapes: 1) Choisir matiere  2) Analyser  3) Generer plan");
    ...
    btnToggleMode->setStyleSheet(
        "QPushButton { background: #2e6f93; color: white; border: none; border-radius: 15px; font-size: 12px; font-weight: 800; padding: 0 12px; }"
        "QPushButton:hover { background: #387ea6; }"
    );
    ...
    resumeFrame->setStyleSheet("QFrame { background: #eefaf3; border: 1px solid #b9e1c5; border-radius: 8px; }");
    QVBoxLayout *resumeL = new QVBoxLayout(resumeFrame);
    resumeL->setContentsMargins(10, 7, 10, 7);
    resumeL->setSpacing(4);

    QLabel *lblResumeTitre = new QLabel("Statut module: PRET");
    lblResumeTitre->setStyleSheet("font-size: 13px; font-weight: 900; color: #1f5e38;");
    QLabel *lblResumeTexte = new QLabel("Etape 1: choisissez la matiere puis cliquez sur '1) Analyser fournisseurs'.");
    lblResumeTexte->setWordWrap(true);
    lblResumeTexte->setStyleSheet("font-size: 12px; font-weight: 700; color: #2c5b40;");
    ...
    QLabel *pilotTitle = new QLabel("Pilotage decisionnel");
    ...
    QLabel *lblModes = new QLabel("Modes smart:");
    lblModes->setStyleSheet("font-size: 12px; font-weight: 700; color: #2a4f61;");

    auto modeBtnStyle = QStringLiteral(
        "QPushButton {"
        " background: #e8f2f8;"
        " color: #1f4b62;"
        ...
        " padding: 0 10px;"
        "}"
        "QPushButton:hover { background: #dff0fa; }"
        "QPushButton:pressed { background: #d2e8f5; }"
    );

    QPushButton *btnModeEco = new QPushButton("Eco");
    QPushButton *btnModeEquilibre = new QPushButton("Equilibre");
    QPushButton *btnModeUrgence = new QPushButton("Urgence");
    QPushButton *btnModeAuto = new QPushButton("Auto");
    QPushButton *btnAjuster100 = new QPushButton("Ajuster 100%");
    btnModeEco->setCursor(Qt::PointingHandCursor);
    btnModeEquilibre->setCursor(Qt::PointingHandCursor);
    btnModeUrgence->setCursor(Qt::PointingHandCursor);
    btnModeAuto->setCursor(Qt::PointingHandCursor);
    btnAjuster100->setCursor(Qt::PointingHandCursor);
    btnModeEco->setStyleSheet(modeBtnStyle);
    btnModeEquilibre->setStyleSheet(modeBtnStyle);
    btnModeUrgence->setStyleSheet(modeBtnStyle);
    btnModeAuto->setStyleSheet(modeBtnStyle);
    btnAjuster100->setStyleSheet(modeBtnStyle);
    btnModeAuto->setToolTip("Choisit un mode selon la couverture stock.");
    btnAjuster100->setToolTip("Recalcule automatiquement les poids pour atteindre 100%.");

    QHBoxLayout *modesL = new QHBoxLayout();
    modesL->setSpacing(8);
    modesL->addWidget(lblModes);
    modesL->addWidget(btnModeEco);
    modesL->addWidget(btnModeEquilibre);
    modesL->addWidget(btnModeUrgence);
    modesL->addWidget(btnModeAuto);
    modesL->addWidget(btnAjuster100);
    modesL->addStretch();
    pilotL->addLayout(modesL);
    ...
    QLabel *lblModeHint = new QLabel("Aide: utilisez Auto pour un choix rapide selon la couverture stock.");
    ...
    QLabel *lblPoidsInfo = new QLabel("Total poids: cible 100%.");
    ...
    QLabel *lblResultats = new QLabel("Fournisseurs disponibles");
    ...
    QLabel *recommandation = new QLabel("Fournisseur conseillé: TanLeather SA.");
    ...
    QLabel *selectionInfo = new QLabel("Cliquez une ligne pour choisir manuellement.");
    ...
    auto majPhotoCuir = [=](const QString &matiere) {
        ...
        if (pix.isNull()) {
            ...
            photoSousTitre->setText("Image non disponible.");
            return;
        }
    ...
    QObject::connect(btnModeEco, &QPushButton::clicked, this, [=]() {
        applyPreset("Eco");
    });
    QObject::connect(btnModeEquilibre, &QPushButton::clicked, this, [=]() {
        applyPreset("Equilibre");
    });
    QObject::connect(btnModeUrgence, &QPushButton::clicked, this, [=]() {
        applyPreset("Urgence");
    });
    ...
    QLabel *planTitle = new QLabel("Etape 3 - Plan de ravitaillement");
    ...
    QObject::connect(btnModeAuto, &QPushButton::clicked, this, [=]() {
        const double consoJour = qMax(0.01, sbConsoPrevue->value() / 7.0);
        const double couvertureJours = sbStockActuel->value() / consoJour;

        if (couvertureJours < 5.0) {
            spPoidsPrix->setValue(15);
            spPoidsQualite->setValue(25);
            spPoidsDelai->setValue(45);
            spPoidsStock->setValue(15);
            selectionInfo->setText("Mode auto: Urgence");
            setModeBadge("Mode actif: Auto (Urgence)", "urgence");
            lblModeHint->setText("Aide auto: couverture faible, priorite urgence.");
            lblResumeTitre->setText("Statut module: MODE AUTO URGENCE");
            lblResumeTexte->setText("Le module privilegie delai et disponibilite. Cliquez sur l'etape 3.");
        } else if (couvertureJours < 8.0) {
            spPoidsPrix->setValue(35);
            spPoidsQualite->setValue(30);
            spPoidsDelai->setValue(20);
            spPoidsStock->setValue(15);
            selectionInfo->setText("Mode auto: Equilibre");
            setModeBadge("Mode actif: Auto (Equilibre)", "equilibre");
            lblModeHint->setText("Aide auto: couverture moyenne, mode equilibre.");
            lblResumeTitre->setText("Statut module: MODE AUTO EQUILIBRE");
            lblResumeTexte->setText("Le module garde un compromis cout/qualite/delai. Cliquez sur l'etape 3.");
        } else {
            spPoidsPrix->setValue(50);
            spPoidsQualite->setValue(20);
            spPoidsDelai->setValue(20);
            spPoidsStock->setValue(10);
            selectionInfo->setText("Mode auto: Eco");
            setModeBadge("Mode actif: Auto (Eco)", "eco");
            lblModeHint->setText("Aide auto: bonne couverture, mode eco.");
            lblResumeTitre->setText("Statut module: MODE AUTO ECO");
            lblResumeTexte->setText("Le module privilegie le cout avec risque faible. Cliquez sur l'etape 3.");
        }
        QSettings("FIL_DOR", "ProjetCpp").setValue("ravitaillement/preset", "Auto");
        appendActionLog("Mode auto applique");
        remplirTable();
    });
    ...
    btnPlanifier = new QPushButton("3) Générer plan de ravitaillement");
    ...
    QObject::connect(btnPlanifier, &QPushButton::clicked, this, [=]() {
        if (!*analyseFaite) {
            ...
            lblResumeTexte->setText("Vous devez d'abord lancer '1) Analyser fournisseurs'.");
    ...
    QPushButton *btnCopierDecision = new QPushButton("Copier decision");
    ...
    auto updateDiagnostic = [=]() {
        ...
        if (score >= 75) {
            ...
            effAction->setText("Action prioritaire: ajuster les poids avec 'Ajuster 100%' puis relancer le plan.");
        } else {
            effAction->setText("Action prioritaire: passer en mode Urgence, verifier stock fournisseur et commander immediatement.");
        }
    };
    ...
    QObject::connect(btnModeEco, &QPushButton::clicked, this, [=]() { updateDiagnostic(); });
    QObject::connect(btnModeEquilibre, &QPushButton::clicked, this, [=]() { updateDiagnostic(); });
    QObject::connect(btnModeUrgence, &QPushButton::clicked, this, [=]() { updateDiagnostic(); });
    QObject::connect(btnModeAuto, &QPushButton::clicked, this, [=]() { updateDiagnostic(); });
    ...
    auto applySimpleModeUi = [=](bool simpleEnabled) {
        strategyFrame->setVisible(!simpleEnabled);
        histFrame->setVisible(!simpleEnabled);
        btnToggleMode->setText(simpleEnabled ? "Passer en Avance" : "Passer en Simple");
        QSettings("FIL_DOR", "ProjetCpp").setValue("ravitaillement/simple_mode", simpleEnabled);
    };

    QObject::connect(btnToggleMode, &QPushButton::clicked, this, [=]() {
        const bool nextSimple = !strategyFrame->isHidden();
        applySimpleModeUi(nextSimple);
    });
    ...
    if (savedPreset == "Eco" || savedPreset == "Equilibre" || savedPreset == "Urgence") {
        applyPreset(savedPreset);
    } else if (savedPreset == "Auto") {
        btnModeAuto->click();
    } else {
        applyPreset("Equilibre");
    }
    applySimpleModeUi(simpleModeEnabled);
